...
export class Home extends Component {
  ...
  render() {
    return (
        ...
        <div className='quizapp-text-container'>
          <h1 className='white-text  quizapp-heading'>
          Quiz App
          </h1>
...
<a href="https://accounts.google.com/o/oauth2/v2/auth?scope=https%3A//www.googleapis.com/auth/drive.metadata.readonly&include_granted_scopes=true&response_type=token&state=state_parameter_passthrough_value&redirect_uri=http://localhost:3000&client_id=80299088687-e0hit00vjvm11uqn4qum9otgt5aj5pn6.apps.googleusercontent.com" target="_blank"><  GoogleButton  className='google-btn' /></a>
            ...
            <input className='input-username' type="text" placeholder="Enter your name" onChange={(e) => this.setState({user: e.target.value}) }>
